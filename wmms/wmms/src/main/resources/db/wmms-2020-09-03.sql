...
insert  into `t_sys_param`(`id`,`name`,`config_key`,`config_value`,`is_valid`,`serial`,`update_user_id`,`update_time`,`create_user_id`,`create_time`,`remark`) values (3,'用户默认登录密码','resetPassword','111111',1,1,'','2020-06-08 11:54:52',NULL,NULL,'密码重置数值'),(14,'帧头','header','FDDF',1,2,'','2020-06-12 00:31:14','','2020-06-12 00:31:14','串口通信的帧头'),(15,'源地址','fromAddress','0000',1,3,NULL,'2020-06-12 00:31:14',NULL,'2020-06-12 00:31:14','PC机loRa模块地址'),(16,'lora环境是否测试','isTest','0',1,5,'','2020-09-03 14:12:00',NULL,NULL,'是否lora测试模式1：是；0：否'),(17,'串口名','commName','COM4',1,4,'','2020-07-11 17:31:27',NULL,NULL,''),(18,'串口通信频率','baudrate','9600',1,6,NULL,NULL,NULL,NULL,NULL),(19,'集管端的通讯地址','CENTER_SERVER_URL','http://127.0.0.1:7772/wmms/tools/save',1,1,'','2020-07-27 12:36:35','','2020-07-27 12:36:35','1'),(21,'同步数据默认签名密钥','API_KEY','WBLiNG99Success',1,1,'','2020-07-27 12:37:11','','2020-07-27 12:37:11','1'),(23,'软件的运行模式','app_schema','schema_single',1,1,'','2020-07-27 16:13:25','','2020-07-27 16:12:37','值必须是schema_single（村委端）或者schema_center（集管端）'),(24,'默认多少脉冲对应1方水','default_pluse','10',1,1,'','2020-08-31 13:30:48','','2020-08-31 13:30:48','默认多少脉冲对应1方水'),(25,'默认采用什么计量用水量','water_volume_base','volume',1,1,'','2020-08-31 13:38:07','','2020-08-31 13:38:07','值必须是pluse或者volume，pluse代表根据脉冲计算用水量，volume代表根据用水量'),(26,'前多少方的水免费','free_water','5',1,1,'','','','','前多少方的水免费');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='水表读数（用水记录）';

/*Data for the table `ws_meter_reader` */

insert  into `ws_meter_reader`(`id`,`user_id`,`user_name`,`meter_id`,`meter_sn`,`village_id`,`village_name`,`group_id`,`group_name`,`num`,`volume`,`group_sn`,`user_sn`,`create_time`,`village_sn`,`update_time`,`create_user_id`,`update_user_id`) values (1,20,'张三',42,'SB0001',13,'测试一村',35,'表井一','2031.00',2011,'BJ0001','4943130fc7524b9d94d4844141c1ad2b','2020-09-03 14:11:30','001850','2020-09-03 14:11:30','',''),(2,20,'张三',42,'SB0001',13,'测试一村',35,'表井一','2031.00',2011,'BJ0001','4943130fc7524b9d94d4844141c1ad2b','2020-09-03 14:11:40','001850','2020-09-03 14:11:40','','');
...
insert  into `ws_village`(`id`,`village_name`,`sn`,`address`,`sort_id`,`online`,`create_user_id`,`update_user_id`,`create_time`,`update_time`) values (13,'测试一村','001850','山东省济南市经十路',1,0,'','','2020-09-03 10:57:16','2020-09-03 10:57:16');
