...
CREATE TABLE `t_sys_user` (
  ...
  KEY `sn` (`sn`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用水监测管理平台用户信息表';

/*Data for the table `t_sys_user` */

insert  into `t_sys_user`(`id`,`name`,`id_card`,`phone`,`login_account`,`login_pass`,`type`,`is_valid`,`account_non_expired`,`credentials_non_expired`,`account_non_locked`,`branch_id`,`village_id`,`village_sn`,`village_name`,`update_user_id`,`update_time`,`create_user_id`,`create_time`,`sn`,`login_number`,`remark`) values (1,'超级管理员','370481199106121850','15668307338','superAdmin','$2a$10$AbVhZpRXHuXw.ps2Fc/ICOZzjPT5FKPn5YK87gi1a5ekbrQEC57iu',4,1,1,1,1,0,13,'001850','测试一村','','2020-09-03 19:53:16',NULL,NULL,'dc4d83d08917400fab66dade0896ff85',0,NULL),(2,'管理员','370481199106121850','18615561799','admin','$2a$10$AbVhZpRXHuXw.ps2Fc/ICOZzjPT5FKPn5YK87gi1a5ekbrQEC57iu',2,1,1,1,1,0,13,'001850','测试一村','','2020-09-03 11:00:17',NULL,NULL,'83334bcacbe249e89f124c4289caedc0',0,NULL),(20,'张三','370481199106121850','','zhangsan','$2a$10$rPqdGy.cl.bro7V8/RW95.LfZERyyKb96pQclS/0q0nzSNZP7HW1W',0,1,1,1,1,0,13,'001850','测试一村','','2020-09-25 09:50:21','','2020-09-03 11:03:06','4943130fc7524b9d94d4844141c1ad2b',0,''),(21,'抄表员','370481199106121850','','admin1','$2a$10$AbVhZpRXHuXw.ps2Fc/ICOZzjPT5FKPn5YK87gi1a5ekbrQEC57iu',1,1,1,1,1,0,13,'001850','测试一村','','2020-09-03 19:34:16','','2020-09-03 17:28:12','43174c28f0824b8c879c2df3d9f7e8c9',0,''),(22,'王五','372922199512144416','','test','$2a$10$nfU2tBCNU/1RlR0jZsdV.eEMi.9gkTgu30SJ.qqseDgg0SEoXGPbq',2,1,1,1,1,0,13,'001850','测试一村','','2020-09-25 09:50:21','','2020-09-03 18:28:18','aaa435cdcdd0437bb32fcb86c96fd97a',0,''),(23,'赵四','370481199106121850','','zhaosi','$2a$10$U.ZleODtTYmZ.0CvUrflluowslwoH3vTxisHe3d8FTOdjZBas/W2S',0,1,1,1,1,0,13,'001850','测试一村','','2020-09-25 09:50:22','','2020-09-25 09:50:22','a9d28ed807d242f792fe099386dc9530',NULL,NULL);
...
CREATE TABLE `ws_group` (
  ...
  KEY `village_sn` (`village_sn`),
  KEY `group_sn` (`sn`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='表井';

/*Data for the table `ws_group` */

insert  into `ws_group`(`id`,`sn`,`address`,`group_name`,`village_id`,`village_name`,`village_sn`,`create_time`,`update_time`,`create_user_id`,`update_user_id`) values (35,'BJ0001','0102','表井一',13,'测试一村','001850','2020-09-03 11:03:41','2020-09-25 09:50:21','dc4d83d08917400fab66dade0896ff85',''),(36,'BJ0002','0103','表井二',13,'测试一村','001850','2020-09-25 09:50:22','2020-09-25 09:50:22','','');
...
CREATE TABLE `ws_meter` (
  ...
  KEY `user_sn` (`user_sn`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='水表设备';

/*Data for the table `ws_meter` */

insert  into `ws_meter`(`id`,`sn`,`meter_init`,`meter_num`,`water_sum`,`user_name`,`user_id`,`village_name`,`village_id`,`branch_id`,`group_id`,`meter_type`,`activation_time`,`group_name`,`group_sn`,`village_sn`,`user_sn`,`remark`,`meter_type_sn`,`online`,`pulse`,`pulse_init`,`mac_sn`,`read_time`,`balance_version`,`balance`,`create_time`,`update_time`,`create_user_id`,`update_user_id`) values (42,'SB0001','0.00','0.00','0.00','张三',20,'测试一村',13,0,35,15,'2020-09-03','表井一','BJ0001','001850','4943130fc7524b9d94d4844141c1ad2b','','rtrts',1,'10',0,'0','2020-09-03 19:12:26',1,'0.00','2020-09-03 11:07:27','2020-09-25 09:50:21','',''),(43,'SB002','0.00','0.00','0.00','王五',22,'测试一村',13,0,35,15,'2020-09-03','表井一','BJ0001','001850','aaa435cdcdd0437bb32fcb86c96fd97a','','rtrts',1,'10',0,'2','2020-09-03 19:12:29',0,'0.00','2020-09-03 19:12:14','2020-09-25 09:50:21','',''),(44,'SB1112','0.00','0.00','0.00','',0,'测试一村',13,0,35,15,'2020-09-03','表井一','BJ0001','001850','','','rtrts',0,'10',0,'F','',0,'0.00','2020-09-03 19:18:28','2020-09-25 09:50:21','',''),(45,'12312','0.00','0.00','0.00','张三',20,'测试一村',13,0,35,15,'2020-09-03','表井一','BJ0001','001850','4943130fc7524b9d94d4844141c1ad2b','','rtrts',0,'12',0,'1','',0,'0.00','2020-09-03 19:33:57','2020-09-25 09:50:22','',''),(46,'SB0003','0.00','0.00','0.00','赵四',23,'测试一村',13,0,36,15,'2020-09-25','表井二','BJ0002','001850','a9d28ed807d242f792fe099386dc9530','','rtrts',0,'10',0,'0','',0,'0.00','2020-09-25 09:50:22','2020-09-25 09:50:22','','');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='同步记录';

/*Data for the table `ws_syn` */

insert  into `ws_syn`(`id`,`data_type`,`branch_id`,`create_time`,`update_time`,`create_user_id`,`update_user_id`) values (1,'1',0,'','','','');
