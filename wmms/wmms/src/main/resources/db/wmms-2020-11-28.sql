...
insert  into `t_sys_param`(`id`,`name`,`config_key`,`config_value`,`is_valid`,`serial`,`update_user_id`,`update_time`,`create_user_id`,`create_time`,`remark`) values (3,'用户默认登录密码','resetPassword','111111',1,1,'','2020-06-08 11:54:52',NULL,NULL,'密码重置数值'),(14,'帧头','header','FDDF',1,2,'','2020-06-12 00:31:14','','2020-06-12 00:31:14','串口通信的帧头'),(15,'源地址','fromAddress','0000',1,3,NULL,'2020-06-12 00:31:14',NULL,'2020-06-12 00:31:14','PC机loRa模块地址'),(16,'lora环境是否测试','isTest','0',1,5,'','2020-11-01 11:23:25',NULL,NULL,'是否lora测试模式1：是；0：否'),(17,'串口名','commName','COM6',1,4,'','2020-11-04 18:50:16',NULL,NULL,''),(18,'串口通信频率','baudrate','9600',1,6,NULL,NULL,NULL,NULL,NULL),(19,'集管端的通讯地址','CENTER_SERVER_URL','http://49.232.157.125:7771/wmms/tools/save',1,1,'','2020-07-27 12:36:35','','2020-07-27 12:36:35','1'),(21,'同步数据默认签名密钥','API_KEY','WBLiNG99Success',1,1,'','2020-07-27 12:37:11','','2020-07-27 12:37:11','1'),(23,'软件的运行模式','app_schema','schema_single',1,1,'','2020-07-27 16:13:25','','2020-07-27 16:12:37','值必须是schema_single（村委端）或者schema_center（集管端）'),(24,'默认多少脉冲对应1方水','default_pluse','10',1,1,'','2020-08-31 13:30:48','','2020-08-31 13:30:48','默认多少脉冲对应1方水'),(25,'默认采用什么计量用水量','water_volume_base','volume',1,1,'','2020-08-31 13:38:07','','2020-08-31 13:38:07','值必须是pluse或者volume，pluse代表根据脉冲计算用水量，volume代表根据用水量'),(26,'前多少方的水免费','free_water','5',1,1,'','','','','前多少方的水免费'),(27,'抄表缴费时间','read_meter_time','1',1,1,'','2020-09-03 18:14:10','','2020-09-03 18:14:10','填写1-28之间的一个数字，代表每个月份的几号（比如填写1代表每月1号，填写10代表每月10号），到达这天之后，系统自动抄表并执行自动缴费');
