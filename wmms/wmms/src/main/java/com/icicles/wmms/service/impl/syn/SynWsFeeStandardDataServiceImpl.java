 ...
 * @author lisy
 */
public class SynWsFeeStandardDataServiceImpl extends AbstractSynData<WsFeeStandard> {
    /**
     * 构造函数，对必要的参数赋值
     *
     * @param service      数据服务类
     ...
     */
    public SynWsFeeStandardDataServiceImpl(IService<WsFeeStandard> service, WsSynService wsSynService) {
    ...
    public void saveData(List<WsFeeStandard> data){
        ...
        data) {
            ...
            WsFeeStandard f = super.getService().getOne(queryWrap);
            if (f == null){
