 ...
 * 不同于MabatisPlusGenerator.java
 * 改功能只生成实体类，用于后期添加和修改字段使用
 */
public class PlusOnlyEntityGenerator {

    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\homeworkspace\\wmms";

    //基本包名
    private static String basePackage = "com.icicles";

    //作者
    private static String authorName = "damon";
    //要生成的表名
    private static String[] tables = {"t_sys_user"};    //table前缀
    private static String prefix = "t_";

    //数据库配置四要素
    private static String driverName = "com.mysql.cj.jdbc.Driver";
    private static String url = "jdbc:mysql://106.13.231.226:3306/wmms_db?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
