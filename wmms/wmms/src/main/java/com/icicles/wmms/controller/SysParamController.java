...
import com.icicles.wmms.entity.form.SysParamForm;
import com.icicles.wmms.entity.form.SysParamQueryForm;
...
public class SysParamController {
    ...
    @ApiResponses(
            @ApiResponse(code = 200, message = "处理成功", response = String.class)
    )
    ...
    @GetMapping(value = "")
    public ResponseEntity<SysParam> query(@Param("configKey") String configKey) throws ApiException {
